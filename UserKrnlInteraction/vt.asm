...
EXTERN GUEST_GDTR_LIMIT_INDEX: DWORD
EXTERN GUEST_IDTR_LIMIT_INDEX: DWORD
EXTERN HOST_RIP_INDEX: DWORD
EXTERN HOST_RSP_INDEX: DWORD
EXTERN VECF_PRIMARY_PROCESSOR_BASED_VM_EXECUTION_CONTROLS_INDEX: DWORD
EXTERN VECF_SECONDARY_PROCESSOR_BASED_VM_EXECUTION_CONTROLS_INDEX: DWORD
...
EXTERN ept: QWORD
EXTERN CPUID_C_HANDLER: QWORD
EXTERN MTF_C_HANDLER: QWORD
EXTERN EPT_VIOLATION_C_HANDLER: QWORD
...
SKIP_INVEPT:
	...
	MTF_EXIT PROC		
		...
		mov qword ptr [rbp + 0h], 0 ;MTF need not to inc Rip.
	...
	EPT_VIOLATION_EXIT PROC
		...
		mov qword ptr [rbp + 0h], 0 ;EPT need not to inc Rip.
		...
		vmread r8, rax
		mov r9, gs: [20h]
		lea rax, EPT_VIOLATION_C_HANDLER
		call rax
